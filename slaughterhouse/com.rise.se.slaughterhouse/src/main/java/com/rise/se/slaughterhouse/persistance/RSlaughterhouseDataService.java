...
public abstract class RSlaughterhouseDataService {
	...
	@CreateSqlObject
	abstract RSlaughterhouseDataDAO dao();

	public void create() {
		dao().create();
	}

	public int post(RSlaughterhouseData rslaughterhousedata_){

		return dao().post(rslaughterhousedata_);
	}
	public int put(RSlaughterhouseData rslaughterhousedata_){

		return dao().put(rslaughterhousedata_);
	}
	public List<RSlaughterhouseData> list(){

		return dao().list();
	}
	public RSlaughterhouseData get(String tripNo){
