...
public abstract class RAnimalSlaughterhouseDataService {
	...
	@CreateSqlObject
	abstract RAnimalSlaughterhouseDataDAO dao();

	public void create() {
		dao().create();
	}

	public int post(RAnimalSlaughterhouseData ranimalslaughterhousedata_){

		return dao().post(ranimalslaughterhousedata_);
	}
	public int put(RAnimalSlaughterhouseData ranimalslaughterhousedata_){

		return dao().put(ranimalslaughterhousedata_);
	}
	public List<RAnimalSlaughterhouseData> list(){

		return dao().list();
	}
	public RAnimalSlaughterhouseData get(String animalID){
