...
public abstract class RCarrierSlaughterhouseDataService {
	...
	@CreateSqlObject
	abstract RCarrierSlaughterhouseDataDAO dao();

	public void create() {
		dao().create();
	}

	public int post(RCarrierSlaughterhouseData rcarrierslaughterhousedata_){

		return dao().post(rcarrierslaughterhousedata_);
	}
	public int put(RCarrierSlaughterhouseData rcarrierslaughterhousedata_){

		return dao().put(rcarrierslaughterhousedata_);
	}
	public List<RCarrierSlaughterhouseData> list(){

		return dao().list();
	}
	public RCarrierSlaughterhouseData get(String carrierId){

		return dao().get(carrierId);
	}
	public int delete(String carrierId){

		return dao().delete(carrierId);
	}
	
	public List<RCarrierSlaughterhouseData> getByTripNo(String tripNo){

		return dao().getByTripNo(tripNo);
	}
