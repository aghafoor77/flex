...
public abstract class SlaughterhouseService {
	...
	@CreateSqlObject
	abstract SlaughterhouseDAO dao();

	public void create() {
		dao().create();
	}

	public int post(Slaughterhouse slaughterhouse_){

		return dao().post(slaughterhouse_);
	}
	public int put(Slaughterhouse slaughterhouse_){

		return dao().put(slaughterhouse_);
	}
	public List<Slaughterhouse> list(){

		return dao().list();
	}
	public Slaughterhouse get(String sid){
