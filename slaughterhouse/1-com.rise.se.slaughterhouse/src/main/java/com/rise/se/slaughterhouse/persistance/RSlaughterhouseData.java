...
@Entity
@Table(name = "RSlaughterhouseData")

public class RSlaughterhouseData{
	@Id
	@Column(name = "tripNo")
	...
	public RSlaughterhouseData (){

	}
	public RSlaughterhouseData ( String tripNo,String slaughterhousename,String currentStatus,long expectedArrivalDate,String location,long startDate){
		this.tripNo = tripNo; 
