...
public abstract class FacilityService {
	...
	public List<Facility> getbyfarmid(String farmid){
		return dao().getbyfarmid(farmid);
	}	
	
	public Facility get(String facilityId){

		return dao().get(facilityId);
	}
	
	public Facility getByFacilityFarm(String facilityNr, String farmId){

		return dao().getByFacilityFarm(facilityNr, farmId);
	}
	public int delete(String facilityId){

		return dao().delete(facilityId);
	}
