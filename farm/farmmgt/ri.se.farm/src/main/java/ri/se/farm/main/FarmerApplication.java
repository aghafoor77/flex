 ...
 * }
 * 
 * @Override public String getName() { return "Farmer"; }
 * 
 * public static void main(String[] args) throws Exception {
 * 
 * new FarmerApplication().run(args); }
 * 
 * @Override public void initialize(Bootstrap<FarmerConfiguration> bootstrap){
 * bootstrap.setConfigurationSourceProvider(new SubstitutingSourceProvider(
 * bootstrap.getConfigurationSourceProvider(), new
 * EnvironmentVariableSubstitutor(false))); bootstrap.addBundle(new
 * AssetsBundle()); bootstrap.addBundle(new ViewBundle<FarmerConfiguration>(){
 * 
 * @Override public Map<String, Map<String, String>>
 * getViewConfiguration(FarmerConfiguration configuration) { return
 * configuration.getViewRendererConfiguration(); } }); bootstrap.addBundle(new
 * SwaggerBundle<FarmerConfiguration>(){
 * 
 * @Override public SwaggerBundleConfiguration
 * getSwaggerBundleConfiguration(FarmerConfiguration configuration){ return
 ...
 * 
 * @Override public void run(FarmerConfiguration configuration, Environment
 ...
 * dbi = new DBI(dataSource); FarmerService farmerService =
 * dbi.onDemand(FarmerService.class); farmerService.create(); FarmerResource
 * farmerResource = new FarmerResource(farmerService); enableCORS(environment);
