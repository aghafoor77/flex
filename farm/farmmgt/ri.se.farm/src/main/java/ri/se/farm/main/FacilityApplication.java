 ...
 * 
 * 
 * public class FacilityApplication extends Application<FacilityConfiguration> {
 * 
 * 
 ...
 * 
 * new FacilityApplication().run(args); }
 * 
 * @Override public void initialize(Bootstrap<FacilityConfiguration> bootstrap){
 * bootstrap.setConfigurationSourceProvider(new SubstitutingSourceProvider(
 * bootstrap.getConfigurationSourceProvider(), new
 * EnvironmentVariableSubstitutor(false))); bootstrap.addBundle(new
 * AssetsBundle()); bootstrap.addBundle(new ViewBundle<FacilityConfiguration>(){
 * 
 * @Override public Map<String, Map<String, String>>
 * getViewConfiguration(FacilityConfiguration configuration) { return
 * configuration.getViewRendererConfiguration(); } }); bootstrap.addBundle(new
 * SwaggerBundle<FacilityConfiguration>(){
 * 
 * @Override public SwaggerBundleConfiguration
 * getSwaggerBundleConfiguration(FacilityConfiguration configuration){ return
 ...
 * 
 * @Override public void run(FacilityConfiguration configuration, Environment
 ...
 * dbi = new DBI(dataSource); FacilityService facilityService =
 * dbi.onDemand(FacilityService.class); facilityService.create();
