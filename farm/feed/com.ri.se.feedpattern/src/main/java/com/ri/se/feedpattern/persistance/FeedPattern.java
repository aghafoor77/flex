...
public class FeedPattern{
	...
	public FeedPattern ( String fpid,String certiOfIngredients,String notes,String feedName,String price,String feedType,String percentage,Date creationDate,String foodSource, double volume){
		this.fpid = fpid; 
