...
import com.ri.se.feedpattern.utils.AbstractHealthCheck;

public abstract class FeedPatternService  extends AbstractHealthCheck  {
	...
	@CreateSqlObject
	abstract FeedPatternDAO dao();

	public void create() {
		dao().create();
	}

	public int post(FeedPattern feedpattern_){

		return dao().post(feedpattern_);
	}
	public int put(FeedPattern feedpattern_){

		return dao().put(feedpattern_);
	}
	public List<FeedPattern> list(){

		return dao().list();
	}
	public FeedPattern get(String fpid){

		return dao().get(fpid);
	}
	public int delete(String fpid){

		return dao().delete(fpid);
	}
