...
import com.ri.se.feedtype.utils.AbstractHealthCheck;

public abstract class FeedTypeService  extends AbstractHealthCheck   {
	...
	@CreateSqlObject
	abstract FeedTypeDAO dao();

	public void create() {
		dao().create();
	}

	public int post(FeedType feedtype_){

		return dao().post(feedtype_);
	}
	public int put(FeedType feedtype_){

		return dao().put(feedtype_);
	}
	public List<FeedType> list(){

		return dao().list();
	}
	public FeedType get(String feedName){

		return dao().get(feedName);
	}
	public int delete(String feedName){

		return dao().delete(feedName);
	}
