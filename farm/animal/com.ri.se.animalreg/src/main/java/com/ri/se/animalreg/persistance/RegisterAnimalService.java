...
import com.ri.se.animalreg.utils.AbstractHealthCheck;

public abstract class RegisterAnimalService extends AbstractHealthCheck  {
	...
	@CreateSqlObject
	abstract RegisterAnimalDAO dao();

	public void create() {
		dao().create();
	}

	public int post(RegisterAnimal registeranimal_){

		return dao().post(registeranimal_);
	}
	public int put(RegisterAnimal registeranimal_){

		return dao().put(registeranimal_);
	}
	public List<RegisterAnimal> list(){

		return dao().list();
	}
	public List<RegisterAnimal> listBulls(String sex){

		return dao().listBulls(sex);
	}
	//
	public List<RegisterAnimal> listByStatus(String status){

		return dao().listByStatus(status);
	}	
	
	public RegisterAnimal get(String animalID){
