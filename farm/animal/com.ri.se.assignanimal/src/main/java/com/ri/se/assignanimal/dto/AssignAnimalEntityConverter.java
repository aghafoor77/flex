...
public class AssignAnimalEntityConverter{
	...
	public DTOAssignAnimal getDTOAssignAnimal(AssignAnimal _assignAnimal)  throws Exception {
		...
		_dTOAssignAnimal.setAssignedBy(_assignAnimal.getAssignedBy());
		return _dTOAssignAnimal;
	}
	public DTOAssignAnimalList getDTOAssignAnimalList(List<AssignAnimal> assignAnimals) throws Exception {
		DTOAssignAnimalList dtoAssignAnimalList = new DTOAssignAnimalList();
		for(AssignAnimal aa : assignAnimals) {
			dtoAssignAnimalList.add(getDTOAssignAnimal(aa)); 
		}
		return dtoAssignAnimalList ;
	}
	...
	public AssignAnimal getAssignAnimal(DTOAssignAnimal __dTOAssignAnimal)  throws Exception {
		...
		assignAnimal.setAssignedBy(__dTOAssignAnimal.getAssignedBy());
		return assignAnimal;
	}
}
