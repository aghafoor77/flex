...
public interface AssignAnimalStatusDAO{
	...
	@SqlQuery("select * from AssignAnimalStatus where aaid=:aaid;")
	public List<AssignAnimalStatus> getByAaid(@Bind("aaid") String aaid);

	@SqlQuery("select * from AssignAnimalStatus where aaid IN (SELECT aaid from AssignAnimal WHERE examiner=:examiner);")
	public List<AssignAnimalStatus> getByExaminer(@Bind("examiner") String examiner);
