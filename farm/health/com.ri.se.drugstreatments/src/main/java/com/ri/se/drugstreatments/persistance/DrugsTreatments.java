...
public class DrugsTreatments{
	...
	public DrugsTreatments ( String dtid,Date assignedDate,String reason,String drungs,String refnumber,String examinedBy,String animalID,String reftype, Date endDate, int quarantinePeriod,String isAntibiotic){
		this.dtid = dtid; 
