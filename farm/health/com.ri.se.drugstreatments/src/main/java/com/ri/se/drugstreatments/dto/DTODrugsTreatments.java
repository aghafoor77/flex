...
public class DTODrugsTreatments{
	...
	public DTODrugsTreatments ( String dtid,String assignedDate,String reason,String drungs,String refnumber,String examinedBy,String animalID,String reftype, String endDate, int quarantinePeriod,String isAntibiotic){
		this.dtid = dtid; 
