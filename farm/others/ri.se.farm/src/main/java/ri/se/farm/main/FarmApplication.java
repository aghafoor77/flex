...
public class FarmApplication extends Application<FarmConfiguration> {
	...
	@Override
	public void initialize(Bootstrap<FarmConfiguration> bootstrap){
		bootstrap.setConfigurationSourceProvider(new SubstitutingSourceProvider(
			bootstrap.getConfigurationSourceProvider(), new EnvironmentVariableSubstitutor(false)));
		bootstrap.addBundle(new AssetsBundle());
		bootstrap.addBundle(new ViewBundle<FarmConfiguration>(){
			@Override
			public Map<String, Map<String, String>> getViewConfiguration(FarmConfiguration configuration) {
				return configuration.getViewRendererConfiguration();
			}
		});
		bootstrap.addBundle(new SwaggerBundle<FarmConfiguration>(){
			@Override
			public SwaggerBundleConfiguration getSwaggerBundleConfiguration(FarmConfiguration configuration){
	...
	@Override
	public void run(FarmConfiguration configuration, Environment environment) throws SocketException {
