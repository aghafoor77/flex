...
2. Move to folloiwng path.
	/home/ag/Desktop/RISE/formasapi/com.ri.se.movebullforherd/
3. Execute following command. 
	mvn package 
It will compile the source code and you will see folloiwng meesage on console 
			 BUILD SUCCESS 
4. Update configuration file.
	Open /home/ag/Desktop/RISE/formasapi/com.ri.se.movebullforherd/config.yml file and update following database parameters.
...
5. Deploy REST API.
	...
	java -cp target/movebullforherd-1.0.0-jar-with-dependencies.jar com.ri.se.movebullforherd.MoveBullForHerdApplication server config.yml
