...
public class DTOFeedPattern{
	...
	public DTOFeedPattern ( String fpid,String certiOfIngredients,String notes,String feedName,String pricae,String feedType,String percentage,String creationDate,String foodSource){
		this.fpid = fpid; 
