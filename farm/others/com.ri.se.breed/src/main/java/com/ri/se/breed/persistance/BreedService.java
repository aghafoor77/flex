...
public abstract class BreedService {
	...
	@CreateSqlObject
	abstract BreedDAO dao();

	public void create() {
		dao().create();
	}

	public int post(Breed breed_){

		return dao().post(breed_);
	}
	public int put(Breed breed_){

		return dao().put(breed_);
	}
	public List<Breed> list(){

		return dao().list();
	}
	public Breed get(String breedname){

		return dao().get(breedname);
	}
	public int delete(String breedname){

		return dao().delete(breedname);
	}
