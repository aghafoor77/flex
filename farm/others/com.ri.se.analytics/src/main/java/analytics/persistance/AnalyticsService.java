...
public abstract class AnalyticsService {
	...
	@CreateSqlObject
	abstract AnalyticsDAO dao();

	public void create() {
		dao().create();
	}

	public int post(Analytics analytics_){

		return dao().post(analytics_);
	}
	public int put(Analytics analytics_){

		return dao().put(analytics_);
	}
	public List<Analytics> list(){

		return dao().list();
	}
	public Analytics get(String AID){
