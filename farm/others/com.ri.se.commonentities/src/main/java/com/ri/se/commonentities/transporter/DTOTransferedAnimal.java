...
public class DTOTransferedAnimal {
	...
	public DTOTransferedAnimal(String animalID, String animalIDMother, String birthPlace, String previousFarmContact,
			int currentWeight, String receivedFarmName, String sex, String farmId, String transferDate, String birthDate,
			String breed, String transactionID, long transactionTime, String currentStatus) {
