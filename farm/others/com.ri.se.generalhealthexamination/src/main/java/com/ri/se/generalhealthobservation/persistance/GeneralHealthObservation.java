...
public class GeneralHealthObservation{
	...
	public GeneralHealthObservation ( String ghoid,String limping,String observer,String wound,String bcs,String notes,String swelling,Date gheDate,String animalID,String wight){
		this.ghoid = ghoid; 
