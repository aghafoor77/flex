...
public abstract class CentralHostRegistrationService {
	...
	@CreateSqlObject
	abstract CentralHostRegistrationDAO dao();

	public void create() {
		dao().create();
	}

	public int post(CentralHostRegistration centralhostregistration_){

		return dao().post(centralhostregistration_);
	}
	public int put(CentralHostRegistration centralhostregistration_){

		return dao().put(centralhostregistration_);
	}
	public int putHb(String service, int hb){

		return dao().putHb(service, hb);
	}
	public List<CentralHostRegistration> list(){

		return dao().list();
	}
	public CentralHostRegistration get(String name){
