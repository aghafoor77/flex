...
public abstract class TransporterService {
	...
	@CreateSqlObject
	abstract TransporterDAO dao();

	public void create() {
		dao().create();
	}

	public int post(Transporter transporter_){

		return dao().post(transporter_);
	}
	public int put(Transporter transporter_){

		return dao().put(transporter_);
	}
	public List<Transporter> list(){

		return dao().list();
	}
	public Transporter get(String TID){
