...
public class TransportedCattleMapper implements ResultSetMapper<TransportedCattle> {
	...
	private static final String  enteranceRecord = "enteranceRecord";
	private static final String  notes = "notes";
	private static final String  GHEID = "GHEID";
	private static final String  otherData = "otherData";
	...
	public TransportedCattle map(int i, ResultSet resultSet, StatementContext statementContext) throws SQLException {
		return new TransportedCattle(resultSet.getString(TCID), resultSet.getString(enteranceRecord), resultSet.getString(notes), resultSet.getString(GHEID), resultSet.getString(otherData), resultSet.getString(destination), resultSet.getDouble(temperature), resultSet.getTimestamp(departDate), resultSet.getString(transportType), resultSet.getString(source), resultSet.getString(animalID), resultSet.getString(carriernumber));
