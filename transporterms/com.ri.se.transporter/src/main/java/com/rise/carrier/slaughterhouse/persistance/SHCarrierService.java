...
public abstract class SHCarrierService {
	...
	@CreateSqlObject
	abstract SHCarrierDAO dao();

	public void create() {
		dao().create();
	}

	public int post(SHCarrier shcarrier_){

		return dao().post(shcarrier_);
	}
	public int put(SHCarrier shcarrier_){

		return dao().put(shcarrier_);
	}
	public List<SHCarrier> list(){

		return dao().list();
	}
	public SHCarrier get(String tripNo){
