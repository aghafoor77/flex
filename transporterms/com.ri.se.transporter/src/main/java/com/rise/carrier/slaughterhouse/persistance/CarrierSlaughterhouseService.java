...
public abstract class CarrierSlaughterhouseService {
	...
	@CreateSqlObject
	abstract CarrierSlaughterhouseDAO dao();

	public void create() {
		dao().create();
	}

	public int post(CarrierSlaughterhouse carrierslaughterhouse_){

		return dao().post(carrierslaughterhouse_);
	}
	public int put(CarrierSlaughterhouse carrierslaughterhouse_){

		return dao().put(carrierslaughterhouse_);
	}
	public List<CarrierSlaughterhouse> list(){

		return dao().list();
	}
	public CarrierSlaughterhouse get(String tripNo){

		return dao().get(tripNo);
	}
	public int delete(String tripNo){

		return dao().delete(tripNo);
	}
