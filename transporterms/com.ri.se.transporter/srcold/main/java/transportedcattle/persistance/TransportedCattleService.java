...
public abstract class TransportedCattleService {
	...
	@CreateSqlObject
	abstract TransportedCattleDAO dao();

	public void create() {
		dao().create();
	}

	public int post(TransportedCattle transportedcattle_){

		return dao().post(transportedcattle_);
	}
	public int put(TransportedCattle transportedcattle_){

		return dao().put(transportedcattle_);
	}
	public List<TransportedCattle> list(){

		return dao().list();
	}
	public TransportedCattle get(String TCID){

		return dao().get(TCID);
	}
	public int delete(String TCID){

		return dao().delete(TCID);
	}
