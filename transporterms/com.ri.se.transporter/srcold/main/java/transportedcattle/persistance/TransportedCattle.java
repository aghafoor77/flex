...
public class TransportedCattle{
	...
	public TransportedCattle ( String TCID,String notes,String GHEID,String destination,Date departDate,String transportType,String source,String animalID,String carriernumber){
		this.TCID = TCID; 
		this.notes = notes; 
		this.GHEID = GHEID; 
