...
public interface CarrierDAO{
	@SqlUpdate("CREATE TABLE IF NOT EXISTS `Carrier` ( `CID` varchar(100) NOT NULL,`carrierNumber` varchar(100) NULL DEFAULT NULL,`species` varchar(100) NULL DEFAULT NULL,`transportType` varchar(100) NULL DEFAULT NULL,`TID` varchar(100) NULL DEFAULT NULL,`longDistance` tinyint(1) NULL DEFAULT NULL, PRIMARY KEY (`CID`)) ENGINE=InnoDB DEFAULT CHARSET=latin1;")
	public void create();

	@SqlUpdate("insert into Carrier(CID, carrierNumber, species, transportType, TID, longDistance) values(:CID, :carrierNumber, :species, :transportType, :TID, :longDistance)")
	public int post(@BindBean Carrier carrier_);

	@SqlUpdate("UPDATE Carrier SET CID=:CID, carrierNumber=:carrierNumber, species=:species, transportType=:transportType, TID=:TID, longDistance=:longDistance WHERE CID=:CID")
