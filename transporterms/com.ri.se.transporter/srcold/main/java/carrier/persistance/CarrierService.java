...
public abstract class CarrierService {
	...
	@CreateSqlObject
	abstract CarrierDAO dao();

	public void create() {
		dao().create();
	}

	public int post(Carrier carrier_){

		return dao().post(carrier_);
	}
	public int put(Carrier carrier_){

		return dao().put(carrier_);
	}
	public List<Carrier> list(){

		return dao().list();
	}
	public Carrier get(String CID){
