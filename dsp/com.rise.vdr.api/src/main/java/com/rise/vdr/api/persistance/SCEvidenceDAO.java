...
public interface SCEvidenceDAO{
	...
	@SqlQuery("Select * from SCEvidence where transactionID =:transactionID;")
	public List<SCEvidence> getByTransactionID(@Bind("transactionID") String transactionID);
	
	@SqlQuery("Select * from SCEvidence where transactionID =:transactionID AND resType='DATA';")
	public List<SCEvidence> getByTransactionIDData(@Bind("transactionID") String transactionID);
