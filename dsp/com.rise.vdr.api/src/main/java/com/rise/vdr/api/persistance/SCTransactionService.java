...
public abstract class SCTransactionService {
	...
	public SCTransaction get(String transactionID){
	...
	public List<SCTransaction> isAnimalExist(String  animalID){
		return dao().isAnimalExist(animalID);
	}
		
	public List<SCTransaction> getOwnedAnimals(String transactionReceiver){
		return dao().getOwnedAnimals(transactionReceiver);
	}
	
	public List<SCTransaction> getOwnedUpdatedAnimals(String transactionReceiver, long milli){
		return dao().getOwnedUpdatedAnimals(transactionReceiver,milli);
	}
	
	public List<SCTransaction> fetchFirstTrasaction(String  animalID){
		return dao().fetchFirstTrasaction(animalID);
	}
