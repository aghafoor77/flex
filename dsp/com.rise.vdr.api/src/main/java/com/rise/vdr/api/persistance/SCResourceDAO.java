...
public interface SCResourceDAO{
	@SqlUpdate("CREATE TABLE IF NOT EXISTS `SCResource` ( `did` varchar(100) NOT NULL,`role` varchar(100) NULL DEFAULT NULL,`publickey` varchar(1024) NULL DEFAULT NULL,`company` varchar(100) NULL DEFAULT NULL, PRIMARY KEY (`did`)) ENGINE=InnoDB DEFAULT CHARSET=latin1;")
	public void create();
	...
	@SqlQuery("select * from SCResource where role=:role;")
	public List<SCResource> listByRole(@Bind("role") String role);
