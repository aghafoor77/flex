...
public class FarmAggregation {
	 ...
	 * DTOCentralHostRegistrationList dtoCentralHostRegistrationList =
	 * farmAggregation .fetchAllServicesMetaData(centralRegistry);
	 * 
	 * Map<String, String> msMap =
	 * farmAggregation.extractRequiredServices(farmAggregation.getRegisteredServices
	 * (), dtoCentralHostRegistrationList);
	 * farmAggregation.fetchMicroServiceData(msMap,
	 * "AR-1616756825455");//AR-1614698765941");//"AR-1614698765991");//"AR-111-333-
	 * 222"); }
	 * 
	...
	/*
	 * public void fetchMicroServiceData(Map<String, String> microServcies, String
	 * identity) throws Exception { microServcies.forEach((k, v) -> { try { new
	 * ServiceAggragator().collect(k, v, identity); } catch (Exception e) { // TODO
