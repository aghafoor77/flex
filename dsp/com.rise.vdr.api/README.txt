...
2. Move to folloiwng path.
	/home/devvm/Downloads/restbuilder-master/out/com.rise.vdr.api/
3. Execute following command. 
	mvn package 
It will compile the source code and you will see folloiwng meesage on console 
			 BUILD SUCCESS 
4. Update configuration file.
	Open /home/devvm/Downloads/restbuilder-master/out/com.rise.vdr.api/config.yml file and update following database parameters.
...
5. Deploy REST API.
	...
	java -cp target/veidblock-1.0.0-jar-with-dependencies.jar com.rise.vdr.api.SCTransactionApplication server config.yml
