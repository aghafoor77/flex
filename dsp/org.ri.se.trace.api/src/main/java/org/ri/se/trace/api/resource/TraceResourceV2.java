...
@Path("/tapi/v2")
@Api(value = "/tapi", description = "Traceability API versoin 2")
public class TraceResourceV2 {

	private static final Logger logger_ = Logger.getLogger(TraceResourceV2.class);
	private TAPIConfig tapiConfig;
	private AttachedResourceService attachedResourceService;

	public TraceResourceV2(TAPIConfig tapiConfig, AttachedResourceService attachedResourceService) {
