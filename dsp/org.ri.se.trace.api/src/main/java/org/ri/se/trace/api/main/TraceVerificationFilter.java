...
public class TraceVerificationFilter extends AuthFilter {

	final static Logger logger = LoggerFactory.getLogger(TraceVerificationFilter.class);

	public TraceVerificationFilter() {
