...
public class CertificateHandlingBC {
	...
	public PrivateKey fetchPrivateKey(CertificateSuite certificateSuite, String password, DistinguishName distinguishName) throws Exception {
		X500Name subject = new X500Name(distinguishName.toString());
		StoreHandling storeHandling = new StoreHandling();
		return storeHandling.fetchPrivateKey(certificateSuite, password, distinguishName);
	}
}