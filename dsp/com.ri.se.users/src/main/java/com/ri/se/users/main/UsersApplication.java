package com.ri.se.users.main;

import com.ri.se.users.persistance.*;
import com.ri.se.users.utils.*;
...
public class UsersApplication extends Application<UsersConfiguration> {
	...
	public void initialize(Bootstrap<UsersConfiguration> bootstrap){
		...
		bootstrap.addBundle(new ViewBundle<UsersConfiguration>(){
			@Override
			public Map<String, Map<String, String>> getViewConfiguration(UsersConfiguration configuration) {
				return configuration.getViewRendererConfiguration();
			}
		});
		bootstrap.addBundle(new SwaggerBundle<UsersConfiguration>(){
			@Override
			public SwaggerBundleConfiguration getSwaggerBundleConfiguration(UsersConfiguration configuration){
	...
	@Override
	public void run(UsersConfiguration configuration, Environment environment) throws SocketException {
