...
class RegisterAnimalEdit extends Component {
  ...
  constructor(props) {
    ...
    this.getAnimalRegistrationData();
  }
          ...
          res.json()
            .then(data => {
              ...
              if (data.length === 0) {
                ...
                if (!(data.aboutAnimal === 'purchased')) {
                  this.setState({ aboutAnimal: 'purchased', isnewlyborn: false, ispurchased: true, pregExamRep: [{ aeid: 'Select Mother ID' }], pregnancyExamination: '', animalIDMother: 'NOA' });
                } else {
                  this.setState({ aboutAnimal: 'newlyborn',snewlyborn: true, ispurchased: false });
                }
               
                this.setState({
                  animalID: data.animalID,
                  receivedFarmID: data.receivedFarmID,
                  animalIDMother: data.animalIDMother,
                  notes: data.notes,
                  pregnancyExamination: data.pregnancyExamination,
                  sex: data.sex,
                  weight: data.weight,
                  ...
                  unit: data.unit,
                  receivedFarmName: data.receivedFarmName,
                  previousAnimalID: data.previousAnimalID,
                  aboutAnimal: data.aboutAnimal,
                  others: data.others,
                  status: data.status
                });
              }
  ...
  putGet() {
    ...
    fetch(url, {
      ...
      .catch(error => {
        this.setAlert("Connection Error-", error.message + " (Update Animal Registration)")
        return false
      });
  }
        ...
        <CCol xs="12" sm="9">
          <CCard>
            <CCardHeader>
              ...
              <small>  Update already registered record of animal. </small>
            </CCardHeader>
            <CCardBody>
              <CForm action="" method="post" encType="multipart/form-data" className="form-horizontal">
                <CRow>
                  ...
                  <CCol xs="5">
                    ...
                    <CFormGroup>
                      ...
                      <CInput name="animalID" id="animalID" onChange={this.handleChange.bind(this)}  disabled={true} value={this.state.animalID} placeholder="Enter animal ID" />
                    </CFormGroup>
                  </CCol>
                  <CCol xs="2">
                    <CFormGroup>
                ...
                <CRow>
                  ...
                  <CCol xs="5">
                    <CFormGroup>
                      <CLabel htmlFor="employerID">ID of registrar </CLabel>
            ...
            <CCardFooter>
              <CRow>
                ...
                <CCol xs="2">
                  <CFormGroup>
                    <CButton block color="info" onClick={(e) => this.putGet()}>Save</CButton>
                  </CFormGroup>
                </CCol>
                <CCol xs="2">
                  <CFormGroup>
...
export default RegisterAnimalEdit
