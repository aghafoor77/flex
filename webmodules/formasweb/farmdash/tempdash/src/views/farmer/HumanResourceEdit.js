...
class HumanResourceEdit extends Component {
  ...
  fetchFarmer(){
    let url = "http://localhost:9020/application/v1/farmer/"+this.props.match.params.resourceId;
    fetch(url, {
      method: "GET",
      headers: {
        Accept: "application/json",
            ...
            <CCardBody>
              ...
              <CCol xs="5">
                <CFormGroup>
                  ...
                  <CSelect custom name="role" id="role" disabled={this.state.isDsiabled} onChange={this.handleChange.bind(this)} value={this.state.role}>
