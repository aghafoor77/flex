...
class AssignUserRole extends Component {
	...
	fetchRoles() {
		...
		fetch(url, {
			...
			.catch(error => {
				this.setAlert("Connection Error-", error.message + " (Fetch Roles)")
				return false
			});
	}
						...
						<CCardBody>
							<CForm action="" method="post" encType="multipart/form-data" className="form-horizontal">
								<CRow>
									...
									<CCol xs="5">
										<CFormGroup>
											...
											<CInput id="email" disabled={this.state.isDsiabled} onChange={this.handleChange.bind(this)} value={this.state.email} placeholder="email" />
										</CFormGroup>
									</CCol>
									<CCol xs="1">
									</CCol>
								...
								<CRow>
									...
									<CCol xs="5">
										<CFormGroup>
											<CLabel htmlFor="company">Company (Organization) Name</CLabel>
											<CInput name="company" id="company" onChange={this.handleChange.bind(this)} value={this.state.company} placeholder="Company name" />
										</CFormGroup>
									</CCol>
								</CRow>
							</CForm>
