...
const FacilityDetail = React.lazy(() => import('./views/farm/FacilityDetail'));
const UsersList = React.lazy(() => import('./views/farmer/UsersList'));

const AssignUserRole = React.lazy(() => import('./views/farmer/AssignUserRole'));
...
const AssignHealthAnimalsList = React.lazy(() => import('./views/animals/AssignHealthAnimalsList'));
const AssignHealthAnimalsTable = React.lazy(() => import('./views/animals/AssignHealthAnimalsTable'));
const AssignHealthAnimalsStatus = React.lazy(() => import('./views/animals/AssignHealthAnimalsStatus'));
const ExaminarAssignedStatus = React.lazy(() => import('./views/animals/ExaminarAssignedStatus'));
const AssignExaminer = React.lazy(() => import('./views/animals/examiner/AssignExaminer'));
const AssignExaminarStatus = React.lazy(() => import('./views/animals/examiner/AssignExaminarStatus'));
const ExaminerGeneralAnimalHealth = React.lazy(() => import('./views/animals/examiner/ExaminerGeneralAnimalHealth'));



const ObservationDetail = React.lazy(() => import('./views/animals/ObservationDetail'));
...
const ADG = React.lazy(() => import('./views/analytics/ADG'));
...
const routes = [
  ...
  { path: '/farm/faciities/:facilityId', name: 'Facilities', component: FacilityDetail},
  ...
  { path: '/humanresource/userlist', name: 'List Users', component: UsersList , exact: true },
  
  { path: '/humanresource/assignuser/:veid', name: 'Assign Role', component: AssignUserRole , exact: true },
  ...
  { path: '/animals/health/:aasid', name: 'General Health Examination', component: ExaminerGeneralAnimalHealth },
  { path: '/animals/health', name: 'General Health Examination', component: GeneralAnimalHealth },
  { path: '/animal/aa4health/list', name: 'Assigned for Examination', component: AssignHealthAnimalsTable },  
  { path: '/animal/aa4health', name: 'Health Examination Assignment', component: AssignHealthAnimalsList },
  
 
  { path: '/animal/aa4healthstatus/animalid/:aaid', name: 'Health Examination Assignment', component: AssignHealthAnimalsStatus },
  { path: '/animal/aa4healthstatus/showstatus/:aaid', name: 'Request Status', component: ExaminarAssignedStatus},  
  
  { path: '/animal/assigned/mylist/:aaid', name: 'Assigned Task', component: AssignExaminarStatus },
  { path: '/animal/assigned/mylist', name: 'Assigned Tasks', component: AssignExaminer },
  ...
  { path: '/animals/observationrecords', name: 'General Health Observation Edit', component: ObservationDetail },
  ...
  { path: '/analytics/ADG', name: 'ADG', component: ADG }
