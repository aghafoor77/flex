...
class FarmData extends Component {
	...
	fetchFarmData() {
		let url = "http://localhost:9020/application/v1/farm";// window.sessionStorage.getItem(endpoints.MB)
																// +
																// '/application/v1/movebullforherd'
		fetch(url, {
			method: "GET",
			headers: {
			          ...
			          <CCard>
			            ...
			            <CCardBody>
		                  ...
		                  <CFormGroup>
			                ...
			                <CInput id="farmid" placeholder="Enter your company name" value={this.state.farmdata.farmId} />
			              </CFormGroup>
		                  </CCol>
		                  <CCol xs="2">
		                  <CFormGroup>
			                <CLabel htmlFor="owner">Owner</CLabel>
			                <CInput id="owner" placeholder="DE1234567890" value={this.state.farmdata.owner} />
			              </CFormGroup>
		                  </CCol>
		                  <CCol xs="4">
		                  <CFormGroup>
			                <CLabel htmlFor="ad">Approval date</CLabel>
			                <CInput id="ad" placeholder="Enter date name" value={this.state.farmdata.dateTime}/>
			              </CFormGroup>
		                  </CCol>
		                  <CCol xs="1">
		                  </CCol>
			                ...
			                <CRow>
			                  ...
			                  <CCol xs="5">
			                    <CFormGroup>
			                      ...
			                      <CInput id="company" placeholder="Enter your company name" value={this.state.farmdata.farmCompany} />
			                    </CFormGroup>
			                  </CCol>
			                  <CCol xs="5">
			                    <CFormGroup>
			                      <CLabel htmlFor="displayname">Display Name</CLabel>
			                      <CInput id="displayname" placeholder="Enter display form name" value={this.state.farmdata.farmName} />
			                    </CFormGroup>
			                  </CCol>
			                  <CCol xs="1">
			                  </CCol>
			                ...
			                <CRow>
			                  ...
			                  <CCol xs="5">
			                    <CFormGroup>
			                      ...
			                      <CInput type="email" id="email-input" name="email-input" placeholder="Enter Email" autoComplete="email" value={this.state.farmdata.email} />
			                    </CFormGroup>
			                  </CCol>
			                  <CCol xs="5">
			                    <CFormGroup>
			                      <CLabel htmlFor="contact">Contact #</CLabel>
			                      <CInput id="contact" placeholder="Enter contact number with country code" value={this.state.farmdata.farmContactNo} />
			                    </CFormGroup>
			                  </CCol>
			                  <CCol xs="1">
			                  </CCol>
			                ...
			                <CRow>
			                  ...
			                  <CCol xs="10">
			                    <CFormGroup>
			                      ...
			                      <CInput type="input" id="street-input" name="street-input" placeholder="Enter Street" autoComplete="email" value={this.state.farmdata.street} />
			                    </CFormGroup>
			                  </CCol>
			                ...
			                <CRow>
			                  ...
			                  <CCol xs="4">
			                    <CFormGroup>
			                      ...
			                      <CInput id="city" placeholder="Enter your city" value={this.state.farmdata.city} />
			                    </CFormGroup>
			                  </CCol>
			                  <CCol xs="2">
			                    <CFormGroup>
			                      <CLabel htmlFor="postalcode">Postal Code</CLabel>
			                      <CInput id="postalcode" placeholder="Enter your postal code" value={this.state.farmdata.postalcode} />
			                    </CFormGroup>
			                  </CCol>
			                  <CCol xs="4">
			                    <CFormGroup>
			                      <CLabel htmlFor="country">Country</CLabel>
			                      <CInput id="country" placeholder="Country name" value={this.state.farmdata.country} />
			                    </CFormGroup>
			                  </CCol>
			                  <CCol xs="1">
			                  </CCol>
